...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/perpus.png') }}">
    ...
    <footer class="sticky-footer" style="margin-top:30px">
        <div class="container">
          <div class="copyright text-center">
            <h6 class="m-0 font-weight-bold text-primary">Sistem informasi<sup>Perpustakaan</sup> - Online</h6>
            <?php $date = date('Y')?>
            <strong>Copyright &copy; {{$date}} <a href="https://github.com/">Perpustakaan</a>.</strong> All rights reserved.
        </div>
      </div>
    </footer>
    <!-- End of Footer -->
